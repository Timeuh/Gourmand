...
const percentage = computed(() =>
  Math.round((props.thisMonth / props.objective) * 100),
);
...
<template>
  <div class="space-y-2 xl:w-3/5 h-full">
    ...
    <div
      class="flex flex-col bg-background-900 shadow-[0_1px_2px_0] shadow-secondary-900/50 p-4 rounded-xl w-full text-secondary-900"
    >
      <div
      ...
      <div class="flex flex-row justify-between items-center w-full">
        <h3 class="text-primary-900 text-2xl">{{ percentage }}%</h3>
        <h4>
          objectif de
