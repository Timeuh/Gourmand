...
<template>
  <div class="space-y-2 w-full">
    ...
    <div
      class="flex flex-col items-center bg-background-900 shadow-[0_1px_2px_0] shadow-secondary-900/50 p-4 rounded-xl w-full"
    >
      <div
        v-for="food in foodsToDisplay"
        class="flex flex-row justify-between items-center space-y-4 w-full"
      >
        <NuxtImg
          :src="food.food?.image"
          :alt="food.food?.name"
          class="rounded-xl size-20 object-cover"
        />
