...
<template>
  ...
  >
    ...
    <label
      ...
      :key="theme.id"
      class="group space-y-2 shadow-[0_0_2px_0] shadow-secondary-900/50 p-2 border border-transparent has-checked:border-primary-900 rounded-xl w-full"
    >
      <div class="flex flex-row justify-between items-center w-full">
        ...
        <input
          ...
          :value="theme.id"
          name="theme"
          class="size-5 accent-primary-900"
        />
      </div>
